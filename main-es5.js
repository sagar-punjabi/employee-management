(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var Employee = /** @class */ (function () {
                function Employee(firstName, lastName, gender, dob, department, id) {
                }
                return Employee;
            }());
            /***/ 
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var CreateEmployeeComponent = /** @class */ (function () {
                function CreateEmployeeComponent(service) {
                ...
                CreateEmployeeComponent.prototype.OnCreateEmp = function () {
                    var _this = this;
                    console.log(this.employee);
                    debugger;
                    var resp = this.service.createEmployee(this.employee);
                    resp.subscribe(function (data) { return _this.employee = _this.emptyEmployee; });
                };
                CreateEmployeeComponent.prototype.ngOnInit = function () {
                    var employee = new _Employee__WEBPACK_IMPORTED_MODULE_2__["Employee"]("", "", "", "", "");
                };
        ...
        /***/ (function (module, __webpack_exports__, __webpack_require__) {
            ...
            var EmployeemgtService = /** @class */ (function () {
                function EmployeemgtService(http) {
                    this.http = http;
                }
                EmployeemgtService.prototype.createEmployee = function (employee) {
                    return this.http.post("http://localhost:8081/create", employee);
                };
                EmployeemgtService.prototype.getAllEmployees = function () {
                    return this.http.get("http://localhost:8081/employees");
                };
                return EmployeemgtService;
            }());
            EmployeemgtService.ctorParameters = function () { return [
